...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('educAssistanceNavBtnMobile')?.addEventListener('click', function(e){ try{ if (e && typeof e.preventDefault === 'function') e.preventDefault(); }catch(err){}; handleEducAssistanceNavClick(e); }, { capture: true });    // Educational Assistance - prefer reusable helper when available
